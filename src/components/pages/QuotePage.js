        ...
        <div className='bg-white p-8 rounded-2xl shadow-xl max-w-2xl mx-auto'>
          <div className='text-center'>
            ...
            <p className='text-gray-600'>
              Your quote request for <strong>{formData.selectedItem}</strong>{" "}
              has been received. Our experts will contact you shortly.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className='bg-white p-8 md:p-12 rounded-2xl shadow-xl border border-gray-200'>
          ...
          <div className='flex justify-center border border-gray-200 rounded-full p-1 mb-8 bg-gray-100'>
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-full text-lg font-semibold transition-all ${
                quoteType === "product"
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-2'>
                Select {quoteType === "product" ? "Product" : "Service"} *
              </label>
              <select
                name='selectedItem'
            ...
            <button
              type='submit'
              className='w-full bg-gradient-to-r from-amber-600 to-orange-600 text-white py-4 rounded-lg text-lg font-semibold flex items-center justify-center gap-2'
            >
              <Send size={20} />
