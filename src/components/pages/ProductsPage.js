...
import { Search, Filter, Microscope, FlaskConical, Globe, Zap, XCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            Explore our comprehensive range of FDA compliant analytical instruments, designed to meet the stringent requirements of the pharmaceutical industry.
          </p>
        </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">Please try a different search or clear the filter.</p>
          </div>
        )}
      </div>
    </div>
