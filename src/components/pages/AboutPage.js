...
const milestones = [
  {
    ...
    description: "Mr. Jayant Joshi established Shreedhar Instruments with a vision to serve the pharmaceutical industry"
  },
  {
    year: "2005",
    event: "Pan-India Expansion",
    description: "Extended operations across major pharmaceutical hubs in India"
  },
  {
    year: "2015",
    event: "Technology Leadership",
    description: "Became the preferred partner for advanced analytical instruments"
  },
  {
    year: "2025",
    event: "Brand Evolution",
    description: "Transitioning to a recognized solutions provider under our own brand"
  }
];
          ...
          {[
            ...
            <div key={i} className="group relative p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2" style={{ backgroundColor: "rgba(255, 255, 255, 0.9)", border: "1px solid rgba(183, 136, 82, 0.15)" }}>
              ...
              <div className="relative z-10">
                ...
                <p className="italic text-lg leading-relaxed" style={{ color: "#9c7649" }}>"{item.content}"</p>
              </div>
            </div>
          ))}
        </div>
              ...
              {milestones.map((milestone, index) => (
                <div key={index} className="relative flex items-center gap-8 group">
                  ...
                  <div className="md:ml-20 p-8 rounded-2xl shadow-lg group-hover:shadow-xl transition-all duration-300 w-full" style={{ backgroundColor: "rgba(255, 255, 255, 0.9)", border: "1px solid rgba(183, 136, 82, 0.15)" }}>
                    ...
                    <h3 className="text-xl font-bold mb-2" style={{ color: "#8b6a3f" }}>{milestone.event}</h3>
