      ...
      {totalFaqs === 0 && searchTerm && (
        <div className="text-center py-12">
          ...
          <p className="mb-6" style={{ color: "#9c7649" }}>
            No FAQs match your search &ldquo;{searchTerm}&rdquo;. Try different keywords or contact us directly.
          </p>
          <button
...
export default function ProductDetailPage() {
  ...
  return (
    ...
    >
              ...
              <div className="flex-grow">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-xl transition-all duration-300 hover:scale-105" style={{ backgroundColor: "rgba(255, 255, 255, 0.8)", border: "1px solid rgba(183, 136, 82, 0.15)" }}>
                    ...
                    <div>
                      <div className="font-semibold text-sm" style={{ color: "#8b6a3f" }}>Available Pan India</div>
                      <div className="text-xs" style={{ color: "#9c7649" }}>Products available across the country</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Product Slider is now at the bottom, outside the main content container */}
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ProductSlider
            currentProduct={product}
            title="Products with Similar Applications"
          />
        </div>
      </div>
    </div>
