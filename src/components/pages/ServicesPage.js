...
import { CheckCircle, ArrowRight, Award, Clock, Shield, Users, Wrench, BookOpen, Phone, MessageCircle, Star } from 'lucide-react';
...
export default function ServicesPage() {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        ...
        setError('Failed to load services. Please ensure the backend server is running.');
  ...
  const serviceProcess = [
    { 
      ...
      description: "Understanding your regulatory requirements, applications, and compliance needs",
      icon: <Users style={{color: '#8b6a3f'}} size={24} />
    },
    { 
      step: "2", 
      title: "Solution Design", 
      description: "Customizing instrument configuration and validation approach for your specific needs",
      icon: <Award style={{color: '#9c7649'}} size={24} />
    },
    { 
      step: "3", 
      title: "Installation & Qualification", 
      description: "Professional IQ/OQ/PQ with complete documentation package and regulatory compliance",
      icon: <Wrench style={{color: '#8b6a3f'}} size={24} />
    },
    { 
      step: "4", 
      title: "Training & Support", 
      description: "Comprehensive operator training and ongoing technical support for optimal performance",
  ...
  if (showServiceForm) {
    return (
      <div className="pt-32 pb-20 min-h-screen" style={{background: 'linear-gradient(135deg, #fefcf8 0%, #fdf8f0 50%, #fcf4e8 100%)'}}>
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 min-h-screen" style={{background: 'linear-gradient(135deg, #fefcf8 0%, #fdf8f0 50%, #fcf4e8 100%)'}}>
      ...
      >
        ...
        <span className="hidden lg:inline font-semibold">Get Service Quote</span>
      </button>
      ...
      <div className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl max-w-4xl mx-auto mb-10 leading-relaxed" style={{color: '#8b6a3f'}}>
              From installation to lifecycle support, we ensure maximum uptime and regulatory compliance 
              for your analytical instruments. Our service commitment goes beyond equipment supply.
            </p>
            ...
            {serviceHighlights.map((highlight, index) => (
              <div key={index} className="group">
                ...
                >
                  ...
                  <h3 className="font-bold mb-3 text-center" style={{color: '#8b6a3f'}}>{highlight.title}</h3>
                  <p className="text-sm text-center leading-relaxed" style={{color: '#9c7649'}}>{highlight.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{color: '#8b6a3f'}}>Our Services</h2>
              <p className="max-w-2xl mx-auto" style={{color: '#9c7649'}}>
                Comprehensive solutions tailored to meet your analytical instrument needs
              </p>
            </div>
            ...
            {loading && (
              <div className="text-center py-20">
                ...
                ></div>
                <p className="mt-4" style={{color: '#8b6a3f'}}>Loading services...</p>
              </div>
            )}
                    ...
                    <div className="flex gap-3">
                      ...
                      <Link 
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.target.style.borderColor = 'rgba(183, 136, 82, 0.5)';
                        }}
                        onMouseLeave={(e) => {
                          e.target.style.backgroundColor = 'rgba(183, 136, 82, 0.05)';
                          e.target.style.borderColor = 'rgba(183, 136, 82, 0.3)';
                        }}
                      >
                        Learn More
          ...
          <div className="mb-20">
            <div 
              ...
              style={{
                background: 'linear-gradient(135deg, #d4b896 0%, #b78852 50%, #a0784a 100%)',
                color: 'white'
              }}
            >
              ...
              <div className="relative z-10">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold mb-4">Need Emergency Service Support?</h2>
                  <p className="max-w-2xl mx-auto text-lg leading-relaxed opacity-90">
                    Critical equipment down? Our emergency response team is available 24/7 to minimize downtime and get your operations back on track.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button 
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{color: '#8b6a3f'}}>Our Service Process</h2>
              <p className="max-w-2xl mx-auto" style={{color: '#9c7649'}}>
                A streamlined approach to ensure quality service delivery at every step
              </p>
            </div>
                ...
                <div key={index} className="group text-center relative">
                  {index < serviceProcess.length - 1 && (
                    <div 
                      ...
                      style={{
                        background: 'linear-gradient(90deg, rgba(183, 136, 82, 0.3) 0%, rgba(183, 136, 82, 0.6) 100%)'
                      }}
                    ></div>
                  )}
                  <div className="relative z-10">
                    ...
                    <h3 className="font-bold mb-3" style={{color: '#8b6a3f'}}>{item.title}</h3>
                    <p className="text-sm leading-relaxed" style={{color: '#9c7649'}}>{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="text-center">
            ...
            >
              <h2 className="text-3xl font-bold mb-4" style={{color: '#8b6a3f'}}>Ready to Get Started?</h2>
              <p className="text-lg mb-8 max-w-2xl mx-auto" style={{color: '#9c7649'}}>
