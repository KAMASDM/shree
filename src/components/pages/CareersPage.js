...
export default function CareersPage() {
  ...
  const careerValues = [
    ...
    },
    {
      ...
      description: "We appreciate empathy, humility, and genuine care in every interaction.",
      icon: "❤️"
    }
  ];
        ...
        <div className="mb-20">
          ...
          <div className="space-y-8">
            {openPositions.length > 0 && openPositions.map((job) => (
              <div key={job.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-amber-600">
                <div className="p-6">
                  <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start">
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">{job.title}</h3>
                      <div className="prose prose-sm text-gray-600" dangerouslySetInnerHTML={{ __html: job.description }} />
                    </div>
