...
import { ArrowRight, Phone, Award, FlaskConical, Shield, Users, Star, CheckCircle, PlayCircle } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center min-h-screen py-20">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="inline-flex items-center gap-3 bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 rounded-full px-6 py-3">
              ...
              <span className="text-amber-100 font-medium">Trusted by 800+ Pharmaceutical Companies</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-slate-300 leading-relaxed max-w-2xl">
                28+ years of excellence in delivering cutting-edge analytical instruments and 
                comprehensive validation services for pharmaceutical manufacturing.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg px-4 py-3 border border-white/10">
            ...
            <div className="pt-8">
              ...
              <div className="flex items-center gap-8 opacity-60">
                <div className="text-white/80 font-semibold text-sm">Beckman Coulter</div>
                <div className="text-white/80 font-semibold text-sm">Met One</div>
                <div className="text-white/80 font-semibold text-sm">Tailin SciTech</div>
                <div className="text-white/80 font-semibold text-sm">Eurping</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-8">
              ...
              <div className="aspect-video bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <div className="text-white">
                    <h3 className="font-semibold text-lg">See Our Solutions in Action</h3>
                    <p className="text-slate-300 text-sm">Watch how we deliver FDA compliance</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { number: "10K+", label: "Installations", sublabel: "Across India" },
                { number: "800+", label: "Customers", sublabel: "Pharma Companies" },
