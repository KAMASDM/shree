// src/app/api/proxy/inquiries/product/route.js
...
export async function POST(request) {
  try {
    const backendUrl = `${BACKEND_BASE_URL}/inquiries/product/`;
    ...
    console.error('❌ Product inquiry proxy request failed:', error);
